...
import {
  ...
  MessageSquare, Send, CheckCircle2, ChevronRight, ArrowLeft,
} from "lucide-react";
  ...
  return (
    <div className="min-h-screen noise" style={{ background: "var(--bg-base)" }}>
      ...
      <div className="fixed inset-0 pointer-events-none"
        style={{ background: "radial-gradient(ellipse 60% 40% at 50% 20%, rgba(192,88,0,0.07) 0%, transparent 70%)" }} />

      <div className="relative max-w-2xl mx-auto px-6 py-16">
        <Link href="/"
          className="inline-flex items-center gap-1.5 text-[12px] mb-10 transition-colors hover:text-white"
          style={{ color: "rgba(100,116,139,0.7)" }}>
          <ArrowLeft size={13} /> Back to JobSynk
        </Link>
          ...
          {step === "topic" && (
            <motion.div key="topic"
              ...
              <div className="mb-10">
                ...
                <p className="text-[14px]" style={{ color: "rgba(148,163,184,0.7)" }}>
                  Pick a topic below and we'll get back to you as soon as possible.
                </p>
              </div>
                ...
                {TOPICS.map((t) => {
                  ...
                  return (
                    <motion.button
                      ...
                      onMouseEnter={(e) => {
                        e.currentTarget.style.background = `rgba(${t.color === "#C05800" ? "192,88,0" : "255,255,255"},0.05)`;
